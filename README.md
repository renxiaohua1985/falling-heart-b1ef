...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/falling-heart-b1ef#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/falling-heart-b1ef
```

A live public deployment of this template is available at [https://falling-heart-b1ef.templates.workers.dev](https://falling-heart-b1ef.templates.workers.dev)
